package com.chaosthirteen.movieplayer;
...
class Movie {
	...
	public String toString(){
		return "Movie [title=" + this.getTitle() + ", moviePath=" + this.getMoviePath()
				+ ", mimeType=" + this.getMimeType() + ", duration="
				+ this.getDuration() + ", thumbnailPath=" + this.getThumbnailPath() + "]";
	}
}